...
type Affiliate = { id: string; name: string; slug: string; draft_branding: AffiliateBranding; published_branding: AffiliateBranding | null; initial_bps: number; renewal_bps: number; renewal_years: number | null };
