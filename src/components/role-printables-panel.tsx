...
export function RolePrintablesPanel({ roleId, roleTitle, printables }: { roleId: string; roleTitle: string; printables: Printable[] }) {
  ...
  const [items, setItems] = useState(printables);
