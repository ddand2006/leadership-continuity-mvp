  ...
  return (
    <main className="app-page">
      <div className="mx-auto w-full max-w-[1380px] px-6 py-12 sm:px-10 lg:px-12">
        ...
        <Link href="/platform-operations/affiliates" className="interactive-contrast mb-8 inline-flex items-center gap-2 rounded-full bg-slate-950 px-6 py-3.5 text-sm font-semibold text-white shadow-lg transition hover:-translate-y-0.5">Manage affiliate partners <span aria-hidden="true">→</span></Link>
